...
//        
//    if ( asteroidsObserver().asteroids().begin()->getData().getVelocity().x < 35) return SuggestedAction{SuggestedAction::YawingAntiClockwise, SuggestedAction::FiringTry};
//if (asteroidsObserver().asteroids().begin()->getData().getVelocity().y > 35) return SuggestedAction{SuggestedAction::YawingClockwise, SuggestedAction::FiringTry};
//        cout <<asteroidsObserver().asteroids().begin()->getData().getVelocity().x <<endl;
//        cout <<asteroidsObserver().asteroids().begin()->getData().getVelocity().y <<endl;
//        cout <<asteroidsObserver().asteroids().begin()->getData().getHealth() <<endl;
//        cout <<asteroidsObserver().asteroids().begin()->getData().getCurrentHitbox().height <<endl;
//        cout <<asteroidsObserver().asteroids().begin()->getData().getCurrentHitbox().left <<endl;//x coor
//        cout <<asteroidsObserver().asteroids().begin()->getData().getCurrentHitbox().top<<endl;
//        cout <<asteroidsObserver().asteroids().begin()->getData().getCurrentHitbox().width <<endl;
}
